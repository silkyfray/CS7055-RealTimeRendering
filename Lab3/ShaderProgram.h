...
//
//};
enum  ShaderType{GOURAUD, PHONG, CEL, CEL_OUTLINE, COOKTOR, BLINNPHONG, BLINNPHONG_TEXTURE, REFLECTREFRACT, REFLECTREFRACT2, TEXTURECUBE, NORMALMAP, REFLECTREFRACTNORMALMAP};
