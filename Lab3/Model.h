...
public:
	...
	virtual void renderGouraud(ShaderProgram *shader, glm::mat4 modelMatrix, glm::mat4 viewMatrix, glm::mat4 projectionMatrix, glm::vec3 lightDirectionWorld) const;
	virtual void renderBlinnPhongTexture(ShaderProgram *shader, glm::mat4 modelMatrix, glm::mat4 viewMatrix, glm::mat4 projectionMatrix, glm::vec3 lightDirectionWorld) const;
	virtual void renderCookTor(ShaderProgram *shader, glm::mat4 modelMatrix, glm::mat4 viewMatrix, glm::mat4 projectionMatrix, glm::vec3 lightDirectionWorld) const;
	virtual void renderCel(ShaderProgram *celShader, ShaderProgram *celOutline, glm::mat4 modelMatrix, glm::mat4 viewMatrix, glm::mat4 projectionMatrix, glm::vec3 lightDirectionWorld, glm::vec4 lineColor, float lineTickness) const;
	virtual void renderCubeMap(ShaderProgram *shader, const CubeMap &cubeMap, glm::mat4 modelMatrix, glm::mat4 viewMatrix, glm::mat4 projectionMatrix) const;
	virtual void renderReflectRefract(ShaderProgram *shader, glm::mat4 modelMatrix, glm::mat4 viewMatrix, glm::mat4 projectionMatrix, glm::vec3 lightDirectionWorld,
		const CubeMap &cubeMap, float eta, float reflectionFactor) const;
	virtual void renderReflectRefract2(ShaderProgram *shader, const CubeMap &cubeMap, glm::mat4 modelMatrix, glm::mat4 viewMatrix, glm::mat4 projectionMatrix, glm::vec3 lightDirectionWorld,
		float eta[3], float fresnel) const;
	virtual void renderNormalMap(ShaderProgram *shader, glm::mat4 modelMatrix, glm::mat4 viewMatrix, glm::mat4 projectionMatrix, glm::vec3 lightDirectionWorld, glm::vec3 lightIntensity, bool renderDiffuse, bool renderNormalMap) const;
	virtual void renderReflectRefractNormalMap(ShaderProgram *shader, const CubeMap &cubeMap, glm::mat4 modelMatrix, glm::mat4 viewMatrix, glm::mat4 projectionMatrix, glm::vec3 lightDirectionWorld,
