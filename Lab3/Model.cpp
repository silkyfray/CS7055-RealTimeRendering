...
void Model::renderCubeMap(ShaderProgram *shader, const CubeMap &cubeMap, glm::mat4 modelMatrix, glm::mat4 viewMatrix, glm::mat4 projectionMatrix) const
{
...
void Model::renderNormalMap(ShaderProgram *shader, glm::mat4 modelMatrix, glm::mat4 viewMatrix, glm::mat4 projectionMatrix, glm::vec3 lightDirectionWorld, glm::vec3 lightIntensity, bool renderDiffuse, bool renderNormalMap) const
{
	glUseProgram(shader->m_Id);
	glm::mat4 modelViewMatrix = viewMatrix * modelMatrix;
	glm::mat4 MVP = projectionMatrix * modelViewMatrix;
...
void Model::renderReflectRefract(ShaderProgram *shader, glm::mat4 modelMatrix, glm::mat4 viewMatrix, glm::mat4 projectionMatrix, glm::vec3 lightDirectionWorld,
...
void Model::renderReflectRefract2(ShaderProgram *shader, const CubeMap &cubeMap, glm::mat4 modelMatrix, glm::mat4 viewMatrix, glm::mat4 projectionMatrix, glm::vec3 lightDirectionWorld,
...
void Model::renderReflectRefractNormalMap(ShaderProgram *shader, const CubeMap &cubeMap, glm::mat4 modelMatrix, glm::mat4 viewMatrix, glm::mat4 projectionMatrix, glm::vec3 lightDirectionWorld,
