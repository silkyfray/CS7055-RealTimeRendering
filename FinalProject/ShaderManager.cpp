...
void ShaderManager::loadShaderVariables(ShaderProgram *shaderProgram)
{
	...
	case ShaderType::WATERCOLOR:
		shaderProgram->m_ActiveVariables["position"] = glGetAttribLocation(shaderProgram->m_Id, "position");
		shaderProgram->m_ActiveVariables["texCoord"] = glGetAttribLocation(shaderProgram->m_Id, "texCoord");
		shaderProgram->m_ActiveVariables["screenTexture"] = glGetUniformLocation(shaderProgram->m_Id, "screenTexture");
		shaderProgram->m_ActiveVariables["pigmentTexture"] = glGetUniformLocation(shaderProgram->m_Id, "pigmentTexture");
		shaderProgram->m_ActiveVariables["turbulenceTexture"] = glGetUniformLocation(shaderProgram->m_Id, "turbulenceTexture");
		shaderProgram->m_ActiveVariables["paperTexture"] = glGetUniformLocation(shaderProgram->m_Id, "paperTexture");
		shaderProgram->m_ActiveVariables["pixelWidth"] = glGetUniformLocation(shaderProgram->m_Id, "pixelWidth");
		shaderProgram->m_ActiveVariables["pixelHeight"] = glGetUniformLocation(shaderProgram->m_Id, "pixelHeight");
		shaderProgram->m_ActiveVariables["offsetX"] = glGetUniformLocation(shaderProgram->m_Id, "offsetX");
		shaderProgram->m_ActiveVariables["offsetY"] = glGetUniformLocation(shaderProgram->m_Id, "offsetY");
		shaderProgram->m_ActiveVariables["brushThreshold"] = glGetUniformLocation(shaderProgram->m_Id, "brushThreshold");
		shaderProgram->m_ActiveVariables["brushColor"] = glGetUniformLocation(shaderProgram->m_Id, "brushColor");
		shaderProgram->m_ActiveVariables["scaleFactorPigment"] = glGetUniformLocation(shaderProgram->m_Id, "scaleFactorPigment");
		shaderProgram->m_ActiveVariables["scaleFactorTurbulence"] = glGetUniformLocation(shaderProgram->m_Id, "scaleFactorTurbulence");
		shaderProgram->m_ActiveVariables["scaleFactorPaper"] = glGetUniformLocation(shaderProgram->m_Id, "scaleFactorPaper");
		shaderProgram->m_ActiveVariables["enableBrush"] = glGetUniformLocation(shaderProgram->m_Id, "enableBrush");
		shaderProgram->m_ActiveVariables["enableWobble"] = glGetUniformLocation(shaderProgram->m_Id, "enableWobble");
		shaderProgram->m_ActiveVariables["enableEdgeDarkening"] = glGetUniformLocation(shaderProgram->m_Id, "enableEdgeDarkening");
		shaderProgram->m_ActiveVariables["enablePigment"] = glGetUniformLocation(shaderProgram->m_Id, "enablePigment");
		shaderProgram->m_ActiveVariables["enableTurbulence"] = glGetUniformLocation(shaderProgram->m_Id, "enableTurbulence");
		shaderProgram->m_ActiveVariables["enablePaper"] = glGetUniformLocation(shaderProgram->m_Id, "enablePaper");
		break;
	}
};
