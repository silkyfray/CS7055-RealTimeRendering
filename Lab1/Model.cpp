...
void Model::renderGouraud(ShaderProgram *shader, glm::mat4 modelMatrix, glm::mat4 viewMatrix, glm::mat4 projectionMatrix, glm::vec3 lightDirectionWorld) const
{
	...
	glUniform3fv(shader->getVariableLocation("l_dir"), 1, glm::value_ptr(lightDirectionEye));
...
void Model::renderPhong(ShaderProgram *shader, glm::mat4 modelMatrix, glm::mat4 viewMatrix, glm::mat4 projectionMatrix, glm::vec3 lightDirectionWorld) const
{
	renderGouraud(shader, modelMatrix, viewMatrix, projectionMatrix, lightDirectionWorld);
}

void Model::renderCel(ShaderProgram *shader, glm::mat4 modelMatrix, glm::mat4 viewMatrix, glm::mat4 projectionMatrix, glm::vec3 lightDirectionWorld) const
{
	renderGouraud(shader, modelMatrix, viewMatrix, projectionMatrix, lightDirectionWorld);
}
...
void Model::switchShader(ShaderProgram *shaderProgram)
{
