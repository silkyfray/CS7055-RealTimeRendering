...
public:
	...
	virtual void renderPhong(ShaderProgram *shader, glm::mat4 modelMatrix, glm::mat4 viewMatrix, glm::mat4 projectionMatrix, glm::vec3 lightDirectionWorld) const;
	virtual void renderCel(ShaderProgram *shader, glm::mat4 modelMatrix, glm::mat4 viewMatrix, glm::mat4 projectionMatrix, glm::vec3 lightDirectionWorld) const;
	ShaderProgram* getShaderProgram() const;
	void switchShader(ShaderProgram *shaderProgramId);
